...
const SettingsPage = () => {
  ...
  const fetchSettings = async () => {
    try {
      ...
      const [profileRes, companyRes, notifRes] = await Promise.all([
        ...
        axios.get(`${API_URL}/settings/notifications`),
      ]);
  ...
  const saveCompanySettings = async () => {
    try {
      setSaving(true);
      await axios.put(`${API_URL}/settings/company`, company);
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <RiBuildingLine className="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/50" />
                    <input
                      type="text"
                      className="input input-bordered w-full pl-10"
                ...
                <div>
                  ...
                  <div className="relative">
                    <RiMoneyDollarCircleLine className="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/50" />
                    <select
                ...
                <div>
                  ...
                  <div className="relative">
                    <RiPhoneLine className="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/50" />
                    <input
                      type="text"
                      className="input input-bordered w-full pl-10"
                      value={company.phone}
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    <RiMapPinLine className="absolute left-3 top-3 text-base-content/50" />
                    <textarea
                ...
                <div>
                  ...
                  <div className="relative">
                    <RiPercentLine className="absolute left-3 top-1/2 transform -translate-y-1/2 text-base-content/50" />
                    <input
                      type="number"
                      className="input input-bordered w-full pl-10"
                ...
                <div>
                  ...
                  <input
                    type="number"
                    className="input input-bordered w-full"
                    value={company.lowStockAlert}
                    onChange={(e) => setCompany({ ...company, lowStockAlert: parseInt(e.target.value) })}
                  />
                </div>
                <div>
                  ...
                  <input
                    type="number"
                    className="input input-bordered w-full"
                    value={company.expiryAlertDays}
                    onChange={(e) => setCompany({ ...company, expiryAlertDays: parseInt(e.target.value) })}
                  />
                </div>
                <div className="md:col-span-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-base-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-base-content/70">Get notified when stock is low</p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex justify-between items-center p-4 bg-base-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-base-content/70">Get notified about expiring medicines</p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex justify-between items-center p-4 bg-base-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-base-content/70">Receive daily sales summary</p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex justify-between items-center p-4 bg-base-200 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-base-content/70">Receive weekly performance report</p>
                </div>
                <input
                  type="checkbox"
